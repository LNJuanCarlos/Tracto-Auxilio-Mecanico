...
class EditarPerfil : AppCompatActivity() {
        ...
        private fun actualizarImagenBD(urlImagenCargada: String) {
            ...
            ref.child(firebaseAuth.uid!!)
                ...
                .addOnSuccessListener {
                    progressDialog.dismiss()
                    Toast.makeText(applicationContext,"Su imagen de perfil, se ah actualizado",Toast.LENGTH_SHORT).show()
                }
                .addOnFailureListener {e->
                    progressDialog.dismiss()
                    Toast.makeText(applicationContext,"${e.message}",Toast.LENGTH_SHORT).show()
        ...
        private val concederPermisoCamara =
            registerForActivityResult(ActivityResultContracts.RequestMultiplePermissions()){resultado->
                ...
                if(concedidoTodos){
                    ...
                    Toast.makeText(
                        this,
                        "El permiso de la camara o almacenamiento ah sido denegado, o ambas fueron denegadas",
                        Toast.LENGTH_SHORT
                    ).show()
                }
            }
        ...
        private fun imageCamara() {
            ...
            contentValues.put(MediaStore.Images.Media.DESCRIPTION,"Descripcion_images")
        ...
        private val concederPermisoAlmacenamiento =
            registerForActivityResult(ActivityResultContracts.RequestPermission()){esConcedido->
                if(esConcedido){
                    ...
                    Toast.makeText(
                        this,
                        "El permiso de almacenamiento ah sido denegada",
                        Toast.LENGTH_SHORT
                    ).show()
                }
            }
